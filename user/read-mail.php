        ...
        <section id="candidates" class="content-header">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-9 bg-[#F1F9F9] border-[0.2px] border-[#B7D3DF] rounded mb-10 padding-2">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <a h ref="mailbox.php"
                                        ...
                                        Back</a>
                                    <div class="box box-primary bg-[#DEEDF0] shadow">
                                        <!-- /.box-header -->
                                        <div class="box-body no-padding">
                                    ...
                                    <div class="box box-primary bg-[#DEEDF0] shadow">
                                        <div class="box-body no-padding">
                                            <div class="mailbox-read-info">
                                                <h3 class="box-title mb-3 font-semibold text-5xl">Reply Message</h3>
                                                <h5>From:
                                    ...
                                    <div class="box box-primary bg-[#DEEDF0] shadow">
                                        ...
                                        <div class="box-body no-padding">
                                            <div class="mailbox-read-info">
                                                <h3 class="box-title mb-3 font-semibold text-5xl">Send Reply</h3>
                                            </div>
                                            <div class="mailbox-read-message">
