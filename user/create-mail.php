                ...
                <div class="row">
                    ...
                    <div class="col-md-9 bg-[#F1F9F9] shadow rounded-xl  padding-2">
                        <form action="add-mail.php" method="post">
                            <div class="box box-primary bg-[#F1F9F9] shadow">
                                ...
                                <div class="box-body">
                                    <div class="form-group">
                                        <select name="to" class="form-control rounded">
                                            <?php
                                    ...
                                    <div class="form-group">
                                        <input class="form-control rounded" name="subject" placeholder="Subject:">
                                    </div>
                                    <div class="form-group">
                                        <textarea class="form-control rounded input-lg" id="description"
