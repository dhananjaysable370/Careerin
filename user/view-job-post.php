...
<head>
    ...
    <title>Careerin - View Jobs</title>
    ...
    <div class="content-wrapper h-full w-full flex align-center justify-center flex-col bg-[#E3F4F4] mt-36"
        ...
        <section id="candidates" class="content-header">
            <div class="container">
                <div class="row">
                    <div
                        class="col-md-9 bg-[#D2E9E9] border-[0.2px] border-[#B7D3DF] padding-2 hover:shadow rounded-xl padding-2">
                        <div class="pull-left">
                        ...
                        <hr>
                        <div>
                            <p class="custompositionicons"><span class="mr-5 custompositionicons">
                    ...
                    <div class="col-md-3">
                        <div class="thumbnail bg-[#D2E9E9] border-[0.2px] border-[#B7D3DF] hover:shadow rounded-xl">
                            ...
                            <div class="caption text-center">
                                <h3 class="text-2xl font-bold text-gray-800 subpixel-antialiased">
                                    <?php echo $row['companyname']; ?>
                                </h3>

                                <p><a href="#"
                                        class="btn btn-success bg-[#14B8A6] rounded-full text-white px-8 py-4 hover:bg-[#0D9488] hover:text-white  font-bold"
                                        role="button">More Info</a>
                                    <hr>
                                <div class="row">
                                    <div class="col-md-4"><a href=""> Report</a></div>
                                    <div class="col-md-4"><a href=""> Email</a></div>
