...
<head>
    ...
    <title>Careerin - Admin Login</title>
...
<body class="hold-transition login-page">
    <div class="login-box">
        ...
        <div class="login-box-body bg-[#D2E9E9] border-[2px] border-[#B7D3DF] shadow-md rounded-xl">
            <p class="login-box-msg mb-10 text-gray-700 text-center font-bold text-5xl">Admin Login</p>
            ...
            <form action="checklogin.php" method="post">
                ...
                <div class="relative z-0 w-full py-4 mt-5 mb-5 group">
