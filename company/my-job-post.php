...
<head>
    ...
    <title>Careerin - My Job Posts</title>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-9 bg-[#F1F9F9] border-[0.2px] border-[#B7D3DF] rounded-xl padding-2">
                        <h2 class="mb-5 text-center font-bold text-5xl">My Job Posts</h2>
                        <p class="text-center m-5">In this section you can view all job posts created by you.</p>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td><a href="view-job-post.php?id=<?php echo $row['id_jobpost']; ?>"
                                                        class="custompositionicons">
                                                        <lord-icon src="https://cdn.lordicon.com/eouimtlu.json"
                                                            trigger="hover" style="width:35px;height:20px">
                                                        </lord-icon><button class="text-blue-500">View Details</button>
                                                    </a></td>
                                            </tr>
                                            <?php
                                                }
