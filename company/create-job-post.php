...
<head>
    ...
    <title>Careerin - Create Job Post</title>
            ...
            <div class="container">
                <div class="row">
                        ...
                        <div class="box box-solid bg-[#DEEDF0] border-[0.2px] border-[#B7D3DF] rounded-lg">
                            ...
                            <div class="box-body no-padding">
                                <ul class="nav nav-pills nav-stacked">
                                    ...
                                    <li class="active"><a href="create-job-post.php" class="custompositionicons">
                    ...
                    <div class="col-md-9 bg-[#F1F9F9] border-[0.2px] border-[#B7D3DF] mb-10 rounded-xl padding-2">
                        <h2 class="mb-5 text-center font-bold text-5xl">Create Job Post</h2>
                        <div class="row">
                                ...
                                <div class="col-md-12 latest-job ">
                                    <div class="form-group">
                                        <input
                                            ...
                                            type="text" id="jobtitle" name="jobtitle" placeholder="Job Title">
                                    </div>
                                    <div class="form-group">

                                        <textarea
                                            class="form-control input-lg block p-2.5 w-full text-2xl text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:border-gray-600 dark:placeholder-gray-400  dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                    ...
                                    <div class="form-group">
                                        <input type="number"
                                            class="form-control  input-lg bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:border-gray-600 dark:placeholder-gray-400 dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                            id="minimumsalary" min="1000" max="1000000" autocomplete="off"
                                            name="minimumsalary" placeholder="Minimum Salary" required="">
                                    </div>
                                    <div class="form-group">
                                        <input type="number"
                                            class="form-control  input-lg bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:border-gray-600 dark:placeholder-gray-400 dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                            id="maximumsalary" name="maximumsalary" min="1000" max="1000000"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="number"
                                            class="form-control  input-lg bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:border-gray-600 dark:placeholder-gray-400 dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                            id="experience" autocomplete="off" name="experience"
                                            placeholder="Experience (in Years) Required" required="">
                                    </div>
                                    <div class="form-group">
                                        <input type="text"
                                            class="form-control  input-lg bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:border-gray-600 dark:placeholder-gray-400 dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                            id="qualification" name="qualification" placeholder="Qualification Required"
                                            required="">
                                    </div>
                                    <div class="form-group">
                                        <button type="submit"
                                            class="btn btn-success rounded shadow font-bold py-4 px-8 bg-teal-600 hover:bg-teal-700  text-white hover:text-white items-center">Create</button>
                                    </div>
                                </div>
                            </form>
                        </div>
