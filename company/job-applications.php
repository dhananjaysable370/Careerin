...
<head>
    ...
    <title>Careerin - Job Applications</title>
            ...
            <div class="container">
                <div class="row">
                        ...
                        <div class="box box-solid bg-[#DEEDF0] border-[0.2px] border-[#B7D3DF] rounded-lg">
                            ...
                            <div class="box-body no-padding ">
                                <ul class="nav nav-pills nav-stacked">
                                    ...
                                    <li class="active "><a href="job-applications.php" class="custompositionicons">
                    ...
                    <div class="col-md-9 bg-[#F1F9F9] border-[0.2px] border-[#B7D3DF] rounded-xl padding-2">
                        <h2 class="mb-5 text-center font-bold text-5xl">Recent Applications</h2>
                        ...
                        if ($result->num_rows > 0) {
                            while ($row = $result->fetch_assoc()) {
                                ?>
                        <div
                            class="attachment-block rounded-lg bg-[#E3F4F4] border-[0.2px] mt-3 border-[#B7D3DF] clearfix padding-2">
                            <h4 class="attachment-heading text-gray-800 text-2xl font-bold"><a
                                    href="user-application.php?id=<?php echo $row['id_user']; ?>&id_jobpost=<?php echo $row['id_jobpost']; ?>">
                                    <?php echo $row['jobtitle'] . ' [@' . $row['firstname'] . ' ' . $row['lastname'] . ']'; ?>
                                </a>
                            </h4>
                            <div class="attachment-text py-4">
