...
<head>
    ...
    <title>Careerin - User Application</title>
    ...
    <div class="content-wrapper h-full w-full flex align-center justify-center flex-col bg-[#E3F4F4]  mt-28"
        ...
        <section id="candidates" class="content-header">
            <div class="container">
                <div class="row">
                    <div class="col-md-3">
                        <div class="box box-solid bg-[#DEEDF0] shadow">
                            <div class="box-header flex items-center justify-center with-border">
                    ...
                    <div class="col-md-9 bg-[#F1F9F9] shadow rounded-xl padding-2">
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="pull-right">
                                    <a href="job-applications.php"
                                        class="btn  btn-success rounded-full shadow font-bold py-4 px-8 bg-teal-600 hover:bg-teal-700 text-white hover:text-white mb-5">Back</a>
                                </div>
                                ...
                                <div>
                                    <?php
                                            ...
                                            echo '<br>';
                                            if ($row['resume'] != "") {
                                                echo '<a href="../uploads/resume/' . $row['resume'] . '" class="btn btn-info rounded-lg shadow-lg font-bold" download="Resume">Download Resume</a>';
                                            }
                                            echo '<br>';
                                            echo '<br>';
                                            echo '<br>';
                                    ...
                                    <div class="row">
                                        <div class="col-md-3 pull-left">
                                            <a href="under-review.php?id=<?php echo $row['id_user']; ?>&id_jobpost=<?php echo $_GET['id_jobpost']; ?>"
                                                class="btn btn-success rounded-lg shadow-lg font-bold">Mark Under
                                                Review</a>
                                        </div>
                                        <div class="col-md-3 pull-right">
                                            <a href="reject.php?id=<?php echo $row['id_user']; ?>&id_jobpost=<?php echo $_GET['id_jobpost']; ?>"
                                                class="btn btn-danger rounded-lg shadow-lg font-bold">Reject
                                                Application</a>
                                        </div>
                                    </div>
                                </div>
